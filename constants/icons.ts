...
// Agricultural-specific icon mappings
export default {
  google,
  home,
  search,
  ...
  rightArrow,
  send,
  // Agricultural mappings
  bed, // -> Crop beds
  bath, // -> Water management
  area, // -> Farm area
  chat, // -> Expert consultation
  phone, // -> Contact support
  carPark, // -> Equipment storage
  cutlery, // -> Harvest tools
  dog, // -> Livestock care
  dumbell, // -> Farm equipment
  laundry, // -> Soil testing
  run, // -> Training center
  swim, // -> Water management
  wifi, // -> Weather updates
  location, // -> Farm location
  edit, // -> Edit farm profile
};
